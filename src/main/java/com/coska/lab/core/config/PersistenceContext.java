...
import com.coska.lab.core.utils.ObjUtils;
...
//  private static final String HIBERNATE_NAMING_STRATEGY = org.hibernate.jpa.AvailableSettings.NAMING_STRATEGY;//"hibernate.ejb.naming_strategy";
	...
	@Bean
	 public DataSource dataSource() {
		 ...
		 driver.setDriverClassName(	env.getProperty("spring.datasource.driver-class-name", "org.postgresql.Driver")); 
		 driver.setUrl(				env.getProperty("spring.datasource.url", 		"jdbc:postgresql://localhost/secret")); 
		 driver.setUsername(		env.getProperty("spring.datasource.username", 	"test")); 
		 driver.setPassword(		env.getProperty("spring.datasource.password", 	"testpassword")); 
		 return driver;
	 }
    ...
    public EntityManagerFactory  entityManagerFactory() {
        ...
        jpaProperties.put(HIBERNATE_DIALECT, 		env.getProperty(HIBERNATE_DIALECT, "org.hibernate.dialect.MariaDBDialect"));        
